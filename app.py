...
def cambiar_estado(id):
    ...
    cursor.execute("SELECT telefono, nombre FROM solicitudes WHERE id=%s", (id,))
    ...
    # 💬 Mensaje automático
    mensaje = f"Hola {nombre}, tu servicio está ahora en estado: {estado}. Mobilehouse."

    # 🔐 Codificar mensaje (evita error 404)
